...
public class RegexAssignment{
    ...
    public static boolean testName(String name){
        return name.matches("([A-Z][A-Za-z]*('[A-Z]+[A-Za-z]*|-[A-Z]+[A-Za-z]*)?)( )([A-Z][A-Za-z]*('[A-Z]+[A-Za-z]*|-[A-Z]+[A-Za-z]*)?)");
    }
    ...
    public static boolean testJavaExecutable(String java){
        return java.matches(".*\n?.*public static void main\\(String\\[\\] [A-Za-z$_][A-Za-z$_0-9]*\\).*\n?.*");
    }
}