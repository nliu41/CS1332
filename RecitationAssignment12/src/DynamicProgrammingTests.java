...
public class DynamicProgrammingTests{
	...
	public void testLCS7() {
		assertEquals("Failed lcs test case 7: Incorrect Value", 0, DynamicProgrammingAssignment.lcs("six", "Seven"));
		assertEquals("Failed lcs test case 7: Incorrect Value", 14, DynamicProgrammingAssignment.lcs("The brown dog ate an apple yesterday.", "Once upon a time, the end."));
	...
	public void testEdit7() {
		assertEquals("Failed edit distance test case 6: Incorrect Value", 18,
				DynamicProgrammingAssignment.edit("ababb", "bbab"));
		assertEquals("Failed edit distance test case 6: Incorrect Value", 18,
				DynamicProgrammingAssignment.edit("sally sells seashells", "by the seashore"));
	}
}
